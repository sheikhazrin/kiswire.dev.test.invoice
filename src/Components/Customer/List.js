...
const CustomerList = (props) => {
  ...
  const columns = [
    ...
    {
      name: 'Address',
      selector: (row) => row.caddress,
      sortable: true,
    },
    {
      name: 'State',
      selector: (row) => row.cstate,
      sortable: true,
    },
    {
      name: 'District',
      selector: (row) => row.cdistrict,
      sortable: true,
    },
    {
      name: 'Action',
      ...
      cell: (row) => (
        <>
          <Link to={'/customer/' + row.id} className="btn btn-info btn-sm">
            Edit
          </Link>
          <button
  ...
  const ExpandedComponent = ({ data }) => (
    <div className="cointainer">
      Updated : {Moment(data.ccreatedAt).format('D/MM/YYYY')}
    ...
    <div className="container">
      <div className="row justify-content-md-center">
        ...
        <div className="col" align="right">
          <Link to={'/customercreate'} className="btn btn-primary btn-sm">
            New Record
          </Link>
        </div>
      </div>
